				...
				<c:if test="${not empty clinicMemberList}">
					<c:forEach var="clinicMember" items="${clinicMemberList}">
						<tr>
							...
							<td id="clinicName${clinicMember.clinicId}"
								contenteditable="true">${clinicMember.clinicName}</td>
							...
							<td>
								<button type="button" class="btn btn-dark"
									onclick="onSaveClick(${clinicMember.clinicId})">Save</button>
							</td>
							<td>
								<button type="button" class="btn btn-danger"
									onclick="onRemoveClick(${clinicMember.clinicId})">Remove</button>
							</td>
						</tr>
					</c:forEach>
				</c:if>
